export const projectsData = {
  ...
  "student-portal": {
    ...
    description: "A full-stack student management system that allows students to submit complaints and track academic activities.",
    ...
    techStack: ["React", "Tailwind", "Node.js", "Express", "Vercel"],
    detailedFeatures: [
      { 
  ...
  "krishi-app": {
    ...
    description: "An agriculture-focused application providing real-time weather updates and insights for farmers in Jharkhand.",
    detailedDescription: "Krishi App is a mission-driven digital solution specifically designed for the farming community in Jharkhand. Leveraging real-time data, it bridge the information gap for farmers, providing them with critical insights needed to make informed farming decisions.",
    ...
    detailedFeatures: [
      ...
      { 
        ...
        description: "Analyze potential crop risks and diseases based on historical climate data.",
        icon: "https://cdn-icons-png.flaticon.com/512/2103/2103371.png"
      },
      { 
        title: "Agricultural Tips", 
        description: "Direct access to expert farming practices and localized recommendations.",
        icon: "https://cdn-icons-png.flaticon.com/512/4342/4342728.png"
      }
    ],
    ...
    live: null,
    images: [
      "https://images.unsplash.com/photo-1592982537447-6f2a6a0c7c18?q=80&w=1471&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1495539406979-bf61750d38ad?q=80&w=1470&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1560493676-04071c5f467b?q=80&w=1474&auto=format&fit=crop",
  ...
  "portfolio": {
    ...
    description: "A premium personal portfolio built using React and Tailwind with modern UI, smooth animations, and 3D design elements.",
    detailedDescription: "This personal portfolio is more than just a resume; it's a digital ecosystem designed to showcase my technical prowess and creative vision. Built on interactivity, it uses modern frontend techniques to provide an immersive user experience.",
    ...
    solutionText: "A custom-built, anti-gravity themed portfolio using advanced CSS and 3D effects to create an immersive brand identity.",
    ...
    techStack: ["React", "Framer Motion", "TailwindCSS", "3D Transforms"],
    detailedFeatures: [
      { 
      ...
      { 
        ...
        description: "Sophisticated design using high-blur backdrops and subtle borders.",
        icon: "https://cdn-icons-png.flaticon.com/512/5968/5968292.png"
      },
      { 
        title: "Page Transitions", 
        description: "Zero-latency feeling with smooth, cinematic page transitions and enter animations.",
        icon: "https://cdn-icons-png.flaticon.com/512/9110/9110052.png"
      }
    ],
    github: "https://github.com/Adityachoubey26/portfolio",
    live: "https://adityachoubey.vercel.app/",
    images: [
      "https://images.unsplash.com/photo-1481143122071-705d2aaee042?q=80&w=1472&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1472&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1517433447752-ce361bd4040e?q=80&w=1470&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1551650975-87deedd944c3?q=80&w=1470&auto=format&fit=crop"
    ]
  }
};
